...
const isNullOrUndefined = <T>(some: T | null | undefined): some is null | undefined =>
...
export default class VDInputGenerator {
              ...
              if (now4[i] === 1) {
                if (isNullOrUndefined(help2)) {
                  ...
                  if (help2 && tmpSet) help2.intersect(tmpSet)
                    ...
                    throw new Error(
                      `Set at ${i} is undefined or help2 is undefined`
                    )
                }
                curSets[i] = true
              }
  ...
  getLetter(i: number): string {
    ...
    switch (this.numberOfSets) {
      ...
      default:
        throw new Error("[getLetter], numberOfSets: " + this.numberOfSets)
    }
  }
}
